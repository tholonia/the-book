...
Again, we see this same structure remarkably represented in the classic reinforcing loop between thinking, feeling, and doing, which is the basis that *Cognitive Behavioral Therapy* is built upon (we’ll refer back to this a bit later).
